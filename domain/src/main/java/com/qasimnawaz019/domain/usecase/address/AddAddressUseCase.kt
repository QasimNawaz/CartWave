...
class AddAddressUseCase(
...
) : SuspendUseCase<AddAddressUseCase.Params, @JvmSuppressWildcards Flow<NetworkCall<BaseResponse<String>>>> {
    ...
    override suspend fun execute(params: Params): @JvmSuppressWildcards Flow<NetworkCall<BaseResponse<String>>> {
        return addressRepo.addAddress(params.address).flowOn(ioDispatcher)
    }
}